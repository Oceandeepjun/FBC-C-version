 ...
 ***************************************************************/
	...
	char vecINFfilename[]="99925vec.inf",vecDataFileName[]="99925vec.dat";
	struct stat vecinf_Status, vecdat_Status;
	stat(vecINFfilename,&vecinf_Status);                              					/*get vecinf file size*/
	stat(vecDataFileName,&vecdat_Status);
	...
	vec_Node_t *vecNodes;
	readVECInfFile(vecINFfilename,vecinf_Array,vecinf_Size);							/*  must be front of readVECDataFile  */
	vecNodes=readVECDataFile(vecDataFileName, vecinf_Array,vec_Curve_array,vecdat_Size,vecinf_Size);
